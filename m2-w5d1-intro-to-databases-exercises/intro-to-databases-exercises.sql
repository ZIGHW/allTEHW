...
SELECT name FROM city WHERE population > 1000000 AND countrycode = 'USA' AND population < 2000000
...
SELECT 2018 - indepyear as yrssinceindep FROM country WHERE indepyear IS NOT NULL
