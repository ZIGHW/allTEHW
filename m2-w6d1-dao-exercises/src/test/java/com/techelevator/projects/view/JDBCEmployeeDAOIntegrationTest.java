...
public class JDBCEmployeeDAOIntegrationTest {
	...
	dao.changeEmployeeDepartment((dao.searchEmployeesByName("Greg", "Gregerson").get(0).getId()), daoDepartment.getAllDepartments().get(0).getId());
	
	Long gregDeptID = dao.searchEmployeesByName("Greg", "Gregerson").get(0).getDepartmentId();
	Long dep0ID = daoDepartment.getAllDepartments().get(0).getId();
